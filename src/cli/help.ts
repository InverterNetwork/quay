...
const COMMANDS: Record<string, CommandSpec> = {
  ...
  enqueue: {
    path: "enqueue",
    synopsis:
      "quay enqueue --repo <id> --brief-file <path> [--worker-execution oneshot|goal] [--ticket-snapshot-file <p>] [--external-ref <r>] [--slack-thread-ref <r>] [--worker-agent <a>] [--worker-model <m>] [--reviewer-agent <a>] [--reviewer-model <m>] [--tag <name>]...",
